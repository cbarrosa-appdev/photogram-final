class LikesController < ApplicationController
  ...
  def create
    ...
    if the_like.valid?
      ...
      redirect_to("/photos/"+params.fetch("query_photo_id"), { :alert => the_like.errors.full_messages.to_sentence })
    end
  end
  ...
  def destroy
    ...
    redirect_to("/photos/"+the_photo.to_s, { :notice => "Like deleted successfully."} )
  end
end
